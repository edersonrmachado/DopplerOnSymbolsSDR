...
if SYSTEM:
    imageFolder="/home/ederson/Desktop/artigoINSCIT/testes/" # pasta de imagens
    figg1='fig1mar1.svg'
    figg2='fig2mar1.svg'
    figg3='fig3mar1.svg'
    figg4='fig4mar1.svg'
    ...
    imageFolder=r"C:\Users\AdmPDI\OneDrive - Sistema Fiergs\Área de Trabalho\git\doutoradoUFRGS\artigoSURVEY\figures\\"
    imageFolder=r"C:\Users\eders\OneDrive\Área de Trabalho\doutorado\git\doutoradoUFRGS\artigoSURVEY\figures\\"
    figg1='fig1mar1.svg'
    figg2='fig2mar1.svg'
    figg3='fig3mar1.svg'
    figg4='fig4mar1.svg'
...
############## salva Grafico
if PRINT_PLOTS:
    plt.savefig(imageFolder+figg2,bbox_inches='tight') #bbox_inches='tight'  evita cortes
#############
plt.show()
...
############## salva Grafico
if PRINT_PLOTS:
    plt.savefig(imageFolder+figg3,bbox_inches='tight') #bbox_inches='tight'  evita cortes
#############
plt.show()
...
############## salva Grafico
if PRINT_PLOTS:
    plt.savefig(imageFolder+figg4,bbox_inches='tight') #bbox_inches='tight'  evita cortes
plt.show()
