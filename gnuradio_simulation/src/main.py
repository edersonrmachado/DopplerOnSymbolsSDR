...
if __name__ == '__main__':
    ...
    simulator= doppler_simulation(symbol_cfg, pay_len=NUMBER_OF_SYMBOLS, doppler_shift=doppler_shift, doppler_rate=doppler_rate_tx, filename=fft_file)
    print("\033[92mRunning simulation...\033[0m")
    simulator.start()
    simulator.wait()
